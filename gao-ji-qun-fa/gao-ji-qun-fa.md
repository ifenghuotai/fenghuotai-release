...
（3）新增“通过文件上传”筛选条件，上传包含粉丝OpenID的文件即可针对该批粉丝进行推送；![](/assets/1519724967%281%29.jpg)（4）在“选择高级功能”页面，新增加了“开启评论”功能，该操作是针对本次推送的所有文章进行的全局操作。当此处勾选后，本次推送的文章列表中，只要在创建素材时也开启了评论功能的，推送成功后即可进行留言。
